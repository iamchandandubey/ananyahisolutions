...
class HomeController extends CI_Controller {
	...
	{
		//SEO
		$header_data['meta_title'] = "Website Design Company";
		$header_data['meta_description'] = "Software Development Company in Hyderabad CRM, Billing, LMS & ERP Solutions";
		...
		$this->load->view('front/home/home_view');
