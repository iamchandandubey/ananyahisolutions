                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                       ...
                       <a href="<?= base_url('all-packages-list') ?>" class="btn btn-primary btn-sm">
                        <i class="bi bi-plus-circle me-1"></i> All Package Lists
                        </a>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-1">
                                        <a href="#" class="text-dark"><?= $package->heading; ?></a>
                                    </h6>
                                    <span class="fw-normal"><?= $package->sub_heading; ?></span>
                                </td>
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal"><?= $package->added_date; ?></p>
                                </td>
                                <td class="border-bottom-0">
                                    <a href="<?= base_url('update-package/'.$package->id) ?>" class="btn btn-primary btn-sm">Update</a>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" class="text-center py-4">
                                ...
                                <span class="ms-2 fw-semibold text-muted">No packages available</span>
                            </td>
                        </tr>
                    <?php endif; ?>
                  </tbody>
